...
const Home = () => {
  return (
    <div className='w-full h-full'>
      <div className="text-white text-4xl sm:text-5xl lg:text-6xl tracking-tight text-center dark:text-white items-center justify-center roboto-bold flex w-full  mt-[6rem]">
